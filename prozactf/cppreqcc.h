/*================================================================//
// cppreqcc.h              CPpreQCC 1.0 - Preprocessor for QuakeC //
//----------------------------------------------------------------//
...
void UndefineItem(int numdefine);
int IsInDefList(char* ident);
bool IsValidEndList(int curpos);
...
// String messages
#define ST_START    "CPPreQCC 1.1 - Written by OfteN[cp] for Prozac CustomTF\n\nInitializing...\n\n"
...
#define ST_PRAGMA_CHECKREDEFS_ON    "CHECK_REDEFINES ON"
#define ST_PRAGMA_CHECKREDEFS_OFF   "CHECK_REDEFINES OFF"
#define ST_PRAGMA_KEEPNEWLINES_ON   "KEEP_NEWLINES ON"
#define ST_PRAGMA_KEEPNEWLINES_OFF  "KEEP_NEWLINES OFF"
...
#define PRAGMA_PROGSSRC         3
#define PRAGMA_PROGSDAT         4

#define PRAGMA_CHECKREDEFS_ON   5
#define PRAGMA_CHECKREDEFS_OFF  6

#define PRAGMA_KEEPNEWLINES_ON  7
#define PRAGMA_KEEPNEWLINES_OFF 8
