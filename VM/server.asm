...
;19: *
;20: *
;21: *  $Id: server.c,v 1.5 2004/12/23 03:16:15 AngelD Exp $
;22: */
...
;28:MOVETARGET CODE
;29:
;30:The angle of the movetarget effects standing and bowing direction, but has no effect on movement, which allways heads to the next target.
;31:
;32:targetname
;33:must be present.  The name of this movetarget.
;34:
;35:target
;36:the next spot to move to.  If not present, stop here for good.
;37:
;38:pausetime
;39:The number of seconds to spend standing or bowing for path_stand or path_bow
;40:
;41:==============================================================================
;42:*/
;43:
...
;47:t_movetarget
;48:
;49:Something has bumped into a movetarget.  If it is a monster
;50:moving towards it, change the next destination and continue.
;51:==============
;52:*/
;53:void t_movetarget(  )
;54:{
line 58
;55:	gedict_t *temp;
;56:	vec3_t  tmpv;
;57:
;58:	if ( other->movetarget != self )
ADDRGP4 other
INDIRP4
CNSTI4 672
ADDP4
...
EQI4 $14
line 62
;62:		return;		// fighting, not following a path
ADDRGP4 $11
JUMPV
LABELV $14
line 64
...
line 68
;67:
;68:	self->movetarget = trap_find( world, FOFS( s.v.targetname ), other->s.v.target );
ADDRGP4 world
INDIRP4
ARGP4
CNSTI4 464
...
ASGNP4
line 69
;69:	self->s.v.goalentity = EDICT_TO_PROG( self->movetarget );
ADDRLP4 20
ADDRGP4 self
INDIRP4
ASGNP4
...
line 71
;70:
;71:	VectorSubtract( self->movetarget->s.v.origin, self->s.v.origin, tmpv );
ADDRLP4 24
ADDRGP4 self
INDIRP4
ASGNP4
...
ASGNF4
line 72
;72:	self->s.v.ideal_yaw = vectoyaw( tmpv );
ADDRLP4 0
ARGP4
ADDRLP4 24
ADDRGP4 vectoyaw
...
;74:	{
line 75
;75:		self->pausetime = g_globalvars.time + 999999;
ADDRGP4 self
INDIRP4
CNSTI4 676
ADDP4
...
;79:}
LABELV $11
endproc t_movetarget 48 12
export movetarget_f
proc movetarget_f 8 28
line 83
;80:
;81:
...
NEU4 $22
line 85
;85:		G_Error( "monster_movetarget: no targetname" );
ADDRGP4 $24
ARGP4
ADDRGP4 G_Error
CALLV
...
line 87
;86:
;87:	self->s.v.solid = SOLID_TRIGGER;
ADDRGP4 self
INDIRP4
CNSTI4 152
ADDP4
...
ASGNF4
line 88
;88:	self->s.v.touch = ( func_t ) t_movetarget;
ADDRGP4 self
INDIRP4
CNSTI4 272
ADDP4
ADDRGP4 t_movetarget
CVPU4 4
CVUI4 4
ASGNI4
line 89
;89:	setsize( self, -8, -8, -8, 8, 8, 8 );
ADDRGP4 self
INDIRP4
ARGP4
ADDRLP4 0
...
;91:}
LABELV $21
endproc movetarget_f 8 28
export SP_path_corner
proc SP_path_corner 4 4
line 97
;92:
;93:/*QUAKED path_corner (0.5 0.3 0) (-8 -8 -8) (8 8 8)
;94:Monsters will continue walking towards the next target corner.
;95:*/
;96:void SP_path_corner(  )
;97:{
line 98
;98:	if ( !CheckExistence(  ) )
ADDRLP4 0
...
;102:	}
;103:	movetarget_f(  );
ADDRGP4 movetarget_f
CALLV
pop
line 104
;104:}
LABELV $25
endproc SP_path_corner 4 4
