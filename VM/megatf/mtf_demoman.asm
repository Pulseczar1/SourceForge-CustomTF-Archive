export BalloonMIRVtouch
code
proc BalloonMIRVtouch 16 12
file "..\src\megatf\mtf_demoman.c"
line 31
;1:/*
;2: *  QWProgs-MegaTF_C
...
;19: *
;20: *
;21: *  $Id: mtf_demoman.c,v 1.00 2006/09/15 XavioR Exp $
;22: */
;23:#include "g_local.h"
;24:void	GrenadeTouch(  );
;25:void	GrenadeExplode(  );
;26:
;27:// MTF Demoman Functions
;28:
;29:// Balloon (Air) Mirv
;30:void BalloonMIRVtouch ( )
;31:{
line 32
;32:	if ( trap_pointcontents( PASSVEC3( self->s.v.origin ) ) == CONTENT_SKY )
ADDRLP4 0
ADDRGP4 self
INDIRP4
ASGNP4
...
line 35
;34:
;35:	if ( trap_pointcontents( PASSVEC3( self->s.v.origin ) ) == -2 )
ADDRLP4 8
ADDRGP4 self
INDIRP4
ASGNP4
...
NEI4 $14
line 36
;36:		SetVector( self->s.v.velocity, 0, 0, 0 );
ADDRGP4 self
INDIRP4
CNSTI4 180
ADDP4
...
LABELV $14
line 38
;37:		//self->s.v.velocity = '0 0 0';
;38:}
LABELV $11
endproc BalloonMIRVtouch 16 12
export BalloonMirvGrenadeLaunch
proc BalloonMirvGrenadeLaunch 44 28
line 41
;39:
;40:void BalloonMirvGrenadeLaunch ( vec3_t org, gedict_t *shooter )
;41:{
line 46
;42:	float xdir;
;43:	float ydir;
...
ASGNP4
line 50
;50:	newmis->s.v.owner = EDICT_TO_PROG( shooter );
ADDRGP4 newmis
INDIRP4
CNSTI4 480
ADDP4
...
ASGNI4
line 51
;51:	newmis->s.v.movetype = MOVETYPE_BOUNCE;
ADDRGP4 newmis
INDIRP4
CNSTI4 148
ADDP4
...
ASGNF4
line 52
;52:	newmis->s.v.solid = SOLID_BBOX;
ADDRGP4 newmis
INDIRP4
CNSTI4 152
ADDP4
...
ASGNF4
line 53
;53:	newmis->s.v.classname = "grenade";
ADDRGP4 newmis
INDIRP4
CNSTI4 216
ADDP4
...
ASGNF4
line 55
;55:	newmis->s.v.touch = ( func_t ) GrenadeTouch;
ADDRGP4 newmis
INDIRP4
CNSTI4 272
ADDP4
...
ASGNI4
line 56
;56:	newmis->s.v.think = ( func_t ) GrenadeExplode;
ADDRGP4 newmis
INDIRP4
CNSTI4 280
ADDP4
...
ASGNI4
line 57
;57:	newmis->s.v.nextthink = g_globalvars.time + 2 + ( g_random(  ) * 2 );
ADDRLP4 28
ADDRGP4 g_random
CALLF4
ASGNF4
...
ASGNF4
line 58
;58:	newmis->s.v.velocity[0] = xdir * 2;
ADDRGP4 newmis
INDIRP4
CNSTI4 180
ADDP4
...
ASGNF4
line 59
;59:	newmis->s.v.velocity[1] = ydir * 2;
ADDRGP4 newmis
INDIRP4
CNSTI4 184
ADDP4
...
ASGNF4
line 60
;60:	newmis->s.v.velocity[2] = zdir * 10;
ADDRGP4 newmis
INDIRP4
CNSTI4 188
ADDP4
...
ASGNF4
line 61
;61:	SetVector( newmis->s.v.avelocity, 0, 0, 0 );
ADDRGP4 newmis
INDIRP4
CNSTI4 204
ADDP4
...
ASGNF4
line 62
;62:	setmodel( newmis, "progs/hgren2.mdl" );
ADDRGP4 newmis
INDIRP4
ARGP4
ADDRGP4 $19
...
pop
line 64
;64:	setorigin( newmis, PASSVEC3( org ) );
ADDRGP4 newmis
INDIRP4
ARGP4
ADDRLP4 40
...
;65:}
LABELV $16
endproc BalloonMirvGrenadeLaunch 44 28
export BalloonMIRVpop
proc BalloonMIRVpop 20 20
line 68
;66:
;67:void BalloonMIRVpop ( )
;68:{
line 71
;69:	float i;
;70:	vec3_t new_org;
;71:	new_org[0] = self->s.v.origin[0];new_org[1] = self->s.v.origin[1];new_org[2] = self->s.v.origin[2] - 1;
ADDRLP4 4
ADDRGP4 self
INDIRP4
CNSTI4 156
...
line 73
;72:
;73:	sound( self, 3, "shambler/sboom.wav", 1, 1 );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 3
...
;77:	{
line 78
;78:		BalloonMirvGrenadeLaunch ( new_org, PROG_TO_EDICT( self->s.v.owner ) );
ADDRLP4 4
ARGP4
ADDRGP4 self
INDIRP4
...
ADDP4
ARGP4
ADDRGP4 BalloonMirvGrenadeLaunch
CALLV
pop
line 79
;79:		i = i + 1;
...
;82:}
LABELV $20
endproc BalloonMIRVpop 20 20
export BalloonMIRVnoise
proc BalloonMIRVnoise 20 20
line 85
;83:
;84:void BalloonMIRVnoise ( )
;85:{
line 86
;86:	self->playerclass = self->playerclass + 1;
ADDRLP4 0
ADDRGP4 self
INDIRP4
CNSTI4 820
...
ASGNI4
line 87
;87:	self->s.v.nextthink = g_globalvars.time + 0.3;
ADDRGP4 self
INDIRP4
CNSTI4 288
ADDP4
...
ASGNF4
line 88
;88:	if ( ( self->s.v.velocity[0] < 3 ) && ( self->s.v.velocity[1] < 3 ) )
ADDRLP4 4
ADDRGP4 self
INDIRP4
ASGNP4
...
GEF4 $29
line 89
;89:		sound ( self, 0, "player/axhit2.wav", 1, 1 );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 0
...
line 91
;90:	else
;91:		sound ( self, 0, "weapons/throw.wav", 1, 1 );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 0
...
LTI4 $33
line 94
;94:		self->s.v.think = ( func_t ) BalloonMIRVpop;
ADDRGP4 self
INDIRP4
CNSTI4 280
ADDP4
ADDRGP4 BalloonMIRVpop
CVPU4 4
CVUI4 4
ASGNI4
LABELV $33
...
;95:}
LABELV $27
endproc BalloonMIRVnoise 20 20
export BalloonMIRV
proc BalloonMIRV 28 28
line 98
;96:
;97:void BalloonMIRV ( )
;98:{
line 99
;99:	if ( self->no_grenades_2 < 1 ) {
ADDRGP4 self
INDIRP4
CNSTI4 844
ADDP4
...
GEI4 $36
line 100
;100:		G_sprint ( self, 2, "You need type 2 grens for an AirMIRV\n" );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 2
...
line 103
;102:	}
;103:	if ( self->last_saveme_sound > g_globalvars.time )
ADDRGP4 self
INDIRP4
CNSTI4 1084
ADDP4
...
line 106
;105:
;106:	self->last_saveme_sound = g_globalvars.time + 2;
ADDRGP4 self
INDIRP4
CNSTI4 1084
ADDP4
...
ASGNF4
line 107
;107:	self->no_grenades_2 = self->no_grenades_2 - 1;
ADDRLP4 0
ADDRGP4 self
INDIRP4
CNSTI4 844
...
ASGNI4
line 108
;108:	G_sprint ( self, 2, "AirMIRV released!\n" );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 2
...
pop
line 109
;109:	sound ( self, 3, "weapons/chngnu1a.wav", 1, 1 );	
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 3
...
ASGNF4
line 113
;113:	newmis->th_die = BalloonMIRVpop;
ADDRGP4 newmis
INDIRP4
CNSTI4 812
ADDP4
...
ASGNP4
line 114
;114:	newmis->s.v.owner = EDICT_TO_PROG( self );
ADDRGP4 newmis
INDIRP4
CNSTI4 480
ADDP4
...
ASGNF4
line 116
;116:	newmis->s.v.movetype = MOVETYPE_FLY;
ADDRGP4 newmis
INDIRP4
CNSTI4 148
ADDP4
...
ASGNF4
line 117
;117:	newmis->s.v.solid = SOLID_BBOX;//1;
ADDRGP4 newmis
INDIRP4
CNSTI4 152
ADDP4
...
ASGNF4
line 118
;118:	newmis->s.v.classname = "bot";//"grenade";
ADDRGP4 newmis
INDIRP4
CNSTI4 216
ADDP4
...
ASGNP4
line 120
;119:	// pablo. netname so i can fudge gun's aim.
;120:	newmis->s.v.netname = "airmirv";
ADDRGP4 newmis
INDIRP4
CNSTI4 396
ADDP4
...
ASGNI4
line 123
;123:	newmis->team_no = self->team_no; // can't shotgun your own airmirvs anyway.
ADDRLP4 12
CNSTI4 960
ASGNI4
ADDRGP4 newmis
...
line 125
;124:
;125:	makevectors ( self->s.v.v_angle );
ADDRGP4 self
INDIRP4
CNSTI4 384
ADDP4
...
EQF4 $47
line 128
;127://		newmis->s.v.velocity = ( g_globalvars.v_forward * 100 ) + ( g_globalvars.v_up * 200 );
;128:		newmis->s.v.velocity[0] =
ADDRGP4 newmis
INDIRP4
CNSTI4 180
ADDP4
...
ASGNF4
line 130
;129:		    g_globalvars.v_forward[0] * 100 + g_globalvars.v_up[0] * 200;
;130:		newmis->s.v.velocity[1] =
ADDRGP4 newmis
INDIRP4
CNSTI4 184
ADDP4
...
ASGNF4
line 132
;131:		    g_globalvars.v_forward[1] * 100 + g_globalvars.v_up[1] * 200;
;132:		newmis->s.v.velocity[2] =
ADDRGP4 newmis
INDIRP4
CNSTI4 188
ADDP4
...
ASGNF4
line 134
;133:		    g_globalvars.v_forward[2] * 100 + g_globalvars.v_up[2] * 200;
;134:	}
ADDRGP4 $48
JUMPV
LABELV $47
...
;135:	else {
line 137
;136:		//newmis->s.v.velocity = aim ( self, 10000 );
;137:		aim( newmis->s.v.velocity );
ADDRGP4 newmis
INDIRP4
CNSTI4 180
ADDP4
...
pop
line 139
;138:		//newmis->s.v.velocity = ( newmis->s.v.velocity * 100 );
;139:		newmis->s.v.velocity[0] = newmis->s.v.velocity[0] * 10;
ADDRLP4 16
ADDRGP4 newmis
INDIRP4
CNSTI4 180
...
ASGNF4
line 140
;140:		newmis->s.v.velocity[1] = newmis->s.v.velocity[1] * 10;
ADDRLP4 20
ADDRGP4 newmis
INDIRP4
CNSTI4 184
...
LABELV $48
line 143
;143:	SetVector( newmis->s.v.avelocity, 0, 0, 0 );
ADDRGP4 newmis
INDIRP4
CNSTI4 204
ADDP4
...
ASGNF4
line 144
;144:	setsize ( newmis, -8, -8, -8, 8, 8, 8 );
ADDRGP4 newmis
INDIRP4
ARGP4
ADDRLP4 16
...
pop
line 145
;145:	setorigin ( newmis, PASSVEC3( self->s.v.origin ) );
ADDRGP4 newmis
INDIRP4
ARGP4
ADDRLP4 24
...
pop
line 146
;146:	newmis->s.v.nextthink = ( func_t ) ( g_globalvars.time + 1 );
ADDRGP4 newmis
INDIRP4
CNSTI4 288
ADDP4
...
ASGNF4
line 147
;147:	newmis->s.v.think = ( func_t ) BalloonMIRVnoise;
ADDRGP4 newmis
INDIRP4
CNSTI4 280
ADDP4
ADDRGP4 BalloonMIRVnoise
CVPU4 4
CVUI4 4
ASGNI4
line 148
;148:	newmis->s.v.touch = ( func_t ) BalloonMIRVtouch;
ADDRGP4 newmis
INDIRP4
CNSTI4 272
ADDP4
...
ASGNI4
line 149
;149:	setmodel ( newmis, "progs/air-mirv.mdl" );
ADDRGP4 newmis
INDIRP4
ARGP4
ADDRGP4 $60
