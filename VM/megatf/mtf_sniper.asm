export MushroomFlame
code
proc MushroomFlame 24 28
file "..\src\megatf\mtf_sniper.c"
line 37
;1:/*
;2: *  QWProgs-MegaTF_C
...
;19: *
;20: *
;21: *  $Id: mtf_sniper.c,v 1.00 2006/09/15 XavioR Exp $
;22: */
;23:#include "g_local.h"
;24:
;25:// MegaTF sniper functions
;26:
;27:// Sniper Drop3 (airstrike)
;28:void AirStrike_Explode ( );
;29:void    s_explode1(  );
;30:/*void    s_explode2(  );
;31:void    s_explode3(  );
;32:void    s_explode4(  );
...
ASGNP4
line 41
;41:	flame->s.v.owner = EDICT_TO_PROG( self );
ADDRLP4 0
INDIRP4
CNSTI4 480
ADDP4
...
ASGNF4
line 44
;44:	flame->s.v.classname = "flamerflame";
ADDRLP4 0
INDIRP4
CNSTI4 216
ADDP4
...
ASGNF4
line 46
;46:	if (self->s.v.classname == "airstrike") {
ADDRGP4 self
INDIRP4
CNSTI4 216
ADDP4
...
NEU4 $13
line 47
;47:		flame->s.v.velocity[0] = g_random(  ) * 1000;
ADDRLP4 8
ADDRGP4 g_random
CALLF4
ASGNF4
...
LABELV $13
line 49
;49:	flame->s.v.velocity[1] = g_random( ) * 1000;
ADDRLP4 8
ADDRGP4 g_random
CALLF4
ASGNF4
...
ASGNF4
line 51
;51:	flame->s.v.think = ( func_t ) s_explode1;
ADDRLP4 0
INDIRP4
CNSTI4 280
ADDP4
...
ASGNI4
line 52
;52:	flame->s.v.nextthink = g_globalvars.time + 0.3;
ADDRLP4 0
INDIRP4
CNSTI4 288
ADDP4
...
ASGNF4
line 53
;53:	setmodel(flame, "progs/s_explod.spr");
ADDRLP4 0
INDIRP4
ARGP4
ADDRGP4 $17
...
pop
line 55
;55:	setorigin(flame, ( self->s.v.origin[0] + 0 ), ( self->s.v.origin[1] + 0 ), ( self->s.v.origin[2] + 16 ) );
ADDRLP4 0
INDIRP4
ARGP4
ADDRLP4 16
...
;59:{
line 60
;60:	sound (self, 0, "weapons/airstrik.wav", 1, 0);
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 0
...
pop
line 61
;61:	self->s.v.think = ( func_t ) AirStrike_Explode;
ADDRGP4 self
INDIRP4
CNSTI4 280
ADDP4
ADDRGP4 AirStrike_Explode
CVPU4 4
CVUI4 4
ASGNI4
line 62
;62:	self->s.v.nextthink = ( func_t ) g_globalvars.time + 1.7;
ADDRGP4 self
INDIRP4
CNSTI4 288
ADDP4
...
;63:}
LABELV $18
endproc AirStrike 0 20
export AirStrike_FlyBy
proc AirStrike_FlyBy 0 20
line 66
;64:
;65:void AirStrike_FlyBy ( )
;66:{
line 67
;67:	G_bprint (1, "INCOMING AIRSTRIKE!\n");
CNSTI4 1
ARGI4
ADDRGP4 $22
ARGP4
...
pop
line 68
;68:	sound(self, 0, "weapons/fighter.wav", 1, 0);
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 0
...
pop
line 69
;69:	self->s.v.think = ( func_t ) AirStrike;
ADDRGP4 self
INDIRP4
CNSTI4 280
ADDP4
...
ASGNI4
line 70
;70:	self->s.v.nextthink = g_globalvars.time + 5;
ADDRGP4 self
INDIRP4
CNSTI4 288
ADDP4
...
;71:}
LABELV $21
endproc AirStrike_FlyBy 0 20
export AirStrike_Explode
proc AirStrike_Explode 12 16
line 74
;72:
;73:void AirStrike_Explode ( )
;74:{
line 75
;75:	trap_WriteByte( MSG_MULTICAST, 23);
CNSTI4 4
ARGI4
CNSTI4 23
ARGI4
...
pop
line 76
;76:	trap_WriteByte( MSG_MULTICAST, 3);
CNSTI4 4
ARGI4
CNSTI4 3
ARGI4
...
pop
line 77
;77:	trap_WriteCoord( MSG_MULTICAST, self->s.v.origin[0] );
CNSTI4 4
ARGI4
ADDRGP4 self
INDIRP4
...
pop
line 78
;78:	trap_WriteCoord( MSG_MULTICAST, self->s.v.origin[1] );
CNSTI4 4
ARGI4
ADDRGP4 self
INDIRP4
...
pop
line 79
;79:	trap_WriteCoord( MSG_MULTICAST, self->s.v.origin[2] );
CNSTI4 4
ARGI4
ADDRGP4 self
INDIRP4
...
pop
line 80
;80:	trap_multicast( PASSVEC3( self->s.v.origin ), 1 );
ADDRLP4 0
ADDRGP4 self
INDIRP4
ASGNP4
...
pop
line 81
;81:	self->s.v.classname = "airstrike";
ADDRGP4 self
INDIRP4
CNSTI4 216
ADDP4
...
pop
line 86
;86:	trap_WriteByte( MSG_MULTICAST, 23);
CNSTI4 4
ARGI4
CNSTI4 23
ARGI4
...
pop
line 87
;87:	trap_WriteByte( MSG_MULTICAST, 10);
CNSTI4 4
ARGI4
CNSTI4 10
ARGI4
...
pop
line 88
;88:	trap_WriteCoord( MSG_MULTICAST, self->s.v.origin[0] );
CNSTI4 4
ARGI4
ADDRGP4 self
INDIRP4
...
pop
line 89
;89:	trap_WriteCoord( MSG_MULTICAST, self->s.v.origin[1] );
CNSTI4 4
ARGI4
ADDRGP4 self
INDIRP4
...
pop
line 90
;90:	trap_WriteCoord( MSG_MULTICAST, self->s.v.origin[2] );
CNSTI4 4
ARGI4
ADDRGP4 self
INDIRP4
...
pop
line 91
;91:	trap_multicast( PASSVEC3( self->s.v.origin ), 1 );
ADDRLP4 4
ADDRGP4 self
INDIRP4
ASGNP4
...
pop
line 93
;93:	T_RadiusDamage(self, PROG_TO_EDICT( self->s.v.owner ), 300, world);
ADDRLP4 8
ADDRGP4 self
INDIRP4
ASGNP4
...
;95:}
LABELV $25
endproc AirStrike_Explode 12 16
export AirStrike_Target
proc AirStrike_Target 32 28
line 98
;96:
;97:void AirStrike_Target ( vec3_t org ) 
;98:{
line 99
;99:	gedict_t *owner = PROG_TO_EDICT( self->s.v.owner );
ADDRLP4 0
ADDRGP4 self
INDIRP4
CNSTI4 480
...
ASGNP4
line 102
;102:	newmis->s.v.movetype = MOVETYPE_NONE;
ADDRGP4 newmis
INDIRP4
CNSTI4 148
ADDP4
...
ASGNF4
line 103
;103:	newmis->s.v.solid = SOLID_NOT;
ADDRGP4 newmis
INDIRP4
CNSTI4 152
ADDP4
...
ASGNF4
line 104
;104:	newmis->team_no = owner->team_no;
ADDRLP4 8
CNSTI4 960
ASGNI4
ADDRGP4 newmis
...
ASGNI4
line 105
;105:	newmis->s.v.owner = EDICT_TO_PROG( owner );
ADDRGP4 newmis
INDIRP4
CNSTI4 480
ADDP4
...
ASGNI4
line 106
;106:	setsize(newmis, 0, 0, 0, 0, 0, 1);
ADDRGP4 newmis
INDIRP4
ARGP4
ADDRLP4 12
...
pop
line 107
;107:	setmodel(newmis, "progs/dot3.spr");
ADDRGP4 newmis
INDIRP4
ARGP4
ADDRGP4 $27
...
ASGNF4
line 110
;110:	setorigin( newmis, PASSVEC3( org ) );
ADDRGP4 newmis
INDIRP4
ARGP4
ADDRLP4 20
...
pop
line 111
;111:	newmis->s.v.nextthink = g_globalvars.time + 10 + ( g_random( ) * 10 );
ADDRLP4 24
ADDRGP4 g_random
CALLF4
ASGNF4
...
ASGNF4
line 112
;112:	newmis->s.v.think = ( func_t ) AirStrike_FlyBy;
ADDRGP4 newmis
INDIRP4
CNSTI4 280
ADDP4
ADDRGP4 AirStrike_FlyBy
CVPU4 4
CVUI4 4
ASGNI4
line 113
;113:}
LABELV $26
endproc AirStrike_Target 32 28
import s_explode1
