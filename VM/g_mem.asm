...
;7:
;8:
;9:#define POOLSIZE	(256 * 1024)
;10:
;11:static char     memoryPool[POOLSIZE];
;12:static int      allocPoint = 0;
;13:
;14:void           *G_Alloc( int size )
;15:{
line 22
;16:	char           *p;
;17:
;18:/*	if ( g_debugAlloc.integer ) {
;19:		G_Printf( "G_Alloc of %i bytes (%i left)\n", size, POOLSIZE - allocPoint - ( ( size + 31 ) & ~31 ) );
;20:	}*/
;21:
;22:	if ( allocPoint + size > POOLSIZE )
ADDRGP4 allocPoint
INDIRI4
ADDRFP4 0
INDIRI4
