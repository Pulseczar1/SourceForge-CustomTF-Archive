export BigAssBullet
code
proc BigAssBullet 40 32
file "..\src\megatf\mtf_hwguy.c"
line 30
;1:/*
;2: *  QWProgs-MegaTF_C
...
;19: *
;20: *
;21: *  $Id: mtf_hwguy.c,v 1.00 2006/09/15 XavioR Exp $
;22: */
;23:#include "g_local.h"
;24:void	make_explosion ( );
;25:// MTF HWGuy Functions
;26:
;27:// 20mm cannon
;28:// self->nojumptime < - fixes the bh w/ 20mm bug
;29:void BigAssBullet ( vec3_t direction, float damage )
;30:{
line 33
;31:	vec3_t org, src, vtemp;
;32:
;33:	makevectors( self->s.v.v_angle );
ADDRGP4 self
INDIRP4
CNSTI4 384
ADDP4
...
pop
line 34
;34:	src[0] = self->s.v.origin[0] + ( g_globalvars.v_forward[0] * 10 );
ADDRLP4 12
ADDRGP4 self
INDIRP4
CNSTI4 156
...
ASGNF4
line 35
;35:	src[1] = self->s.v.origin[1] + ( g_globalvars.v_forward[0] * 10 );
ADDRLP4 12+4
ADDRGP4 self
INDIRP4
CNSTI4 160
...
ASGNF4
line 36
;36:	src[2] = self->s.v.absmin[2] + ( self->s.v.size[2] * 0.7 );
ADDRLP4 36
ADDRGP4 self
INDIRP4
ASGNP4
...
pop
line 38
;38:	VectorScale( direction, 1500, vtemp );
ADDRFP4 0
INDIRP4
ARGP4
CNSTF4 1153138688
...
ASGNF4
line 40
;40:	traceline( PASSVEC3( src ), PASSVEC3( vtemp ), 0, self );
ADDRLP4 12
INDIRF4
ARGF4
ADDRLP4 12+4
...
pop
line 42
;41:	//traceline( src, (src + (direction * 1500)), 0, self );
;42:	if ( g_globalvars.trace_fraction != 1 )
ADDRGP4 g_globalvars+272
INDIRF4
CNSTF4 1065353216
EQF4 $26
line 43
;43:		TraceAttack ( damage, direction );
ADDRFP4 4
INDIRF4
ARGF4
ADDRFP4 0
...
line 45
;44:
;45:	if ( PROG_TO_EDICT( g_globalvars.trace_ent )->s.v.takedamage ) {
...
EQF4 $29
line 46
;46:		org[0] = g_globalvars.trace_endpos[0] - ( g_globalvars.v_forward[0] * 4 );
ADDRLP4 24
...
ASGNF4
line 47
;47:		org[1] = g_globalvars.trace_endpos[1] - ( g_globalvars.v_forward[1] * 4 );
ADDRLP4 24+4
...
ASGNF4
line 48
;48:		org[2] = g_globalvars.trace_endpos[2] - ( g_globalvars.v_forward[2] * 4 );
ADDRLP4 24+8
...
;54:		org[0] = g_globalvars.trace_endpos[0] - ( g_globalvars.v_forward[0] * 4 );
ADDRLP4 24
ADDRGP4 g_globalvars+276
INDIRF4
CNSTF4 1082130432
...
ASGNF4
line 55
;55:		org[1] = g_globalvars.trace_endpos[1] - ( g_globalvars.v_forward[1] * 4 );
ADDRLP4 24+4
ADDRGP4 g_globalvars+276+4
INDIRF4
CNSTF4 1082130432
...
ASGNF4
line 56
;56:		org[2] = g_globalvars.trace_endpos[2] - ( g_globalvars.v_forward[0] * 4 );
ADDRLP4 24+8
ADDRGP4 g_globalvars+276+8
INDIRF4
CNSTF4 1082130432
...
ASGNF4
line 57
;57:		trap_WriteByte( MSG_BROADCAST, SVC_TEMPENTITY );
CNSTI4 4
ARGI4
CNSTI4 23
ARGI4
...
pop
line 58
;58:		trap_WriteByte( MSG_BROADCAST, TE_SPIKE );
CNSTI4 4
ARGI4
CNSTI4 0
ARGI4
...
pop
line 59
;59:		trap_WriteCoord( MSG_BROADCAST, org[0] );
CNSTI4 4
ARGI4
ADDRLP4 24
INDIRF4
...
pop
line 60
;60:		trap_WriteCoord( MSG_BROADCAST, org[1] );
CNSTI4 4
ARGI4
ADDRLP4 24+4
INDIRF4
...
pop
line 61
;61:		trap_WriteCoord( MSG_BROADCAST, org[2] );
CNSTI4 4
ARGI4
ADDRLP4 24+8
INDIRF4
...
pop
line 62
;62:		trap_multicast( PASSVEC3( g_globalvars.trace_endpos ), MULTICAST_PHS );
ADDRGP4 g_globalvars+276
INDIRF4
ARGF4
ADDRGP4 g_globalvars+276+4
...
;66:}
LABELV $11
endproc BigAssBullet 40 32
export W_FireBigAss
proc W_FireBigAss 36 20
line 69
;67:
;68:void W_FireBigAss ( )
;69:{
line 72
;70:	vec3_t dir, vtemp;
;71:
;72:	if ( self->s.v.ammo_shells < 10 )
ADDRGP4 self
INDIRP4
CNSTI4 320
ADDP4
...
pop
line 76
;75://		G_sprint (self, 2, "Ammo chamber jammed!\n"); // I just don't like excess messages
;76:		sound ( self, 1, "weapons/asscan4.wav", 1, 1 );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 1
...
;80:	}
;81:
;82:	self->nojumptime = ( g_globalvars.time + 0.75 );		// stops the 10.30.98 20mm speed "bug"
ADDRGP4 self
INDIRP4
CNSTI4 1016
ADDP4
...
line 85
;83:
;84:	// "weapons/sgun1.wav" was the old sound, this is 11.11.04's sound
;85:	sound( self, 1, "weapons/20mm.wav", 1, 1 );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 1
...
pop
line 93
;90://	self.ammo_shells = (self.ammo_shells - 10);
;91://	self.currentammo = (self.ammo_shells - 10);
;92:	//self->s.v.currentammo = self->s.v.ammo_shells - 10;
;93:	self->s.v.ammo_shells = self->s.v.ammo_shells - 10;
ADDRLP4 28
ADDRGP4 self
INDIRP4
CNSTI4 320
...
ASGNF4
line 94
;94:	self->s.v.currentammo = self->s.v.ammo_shells;
ADDRLP4 32
ADDRGP4 self
INDIRP4
ASGNP4
...
line 96
;95:
;96:	makevectors( self->s.v.v_angle );
ADDRGP4 self
INDIRP4
CNSTI4 384
ADDP4
...
pop
line 97
;97:	dir[0] = g_globalvars.v_forward[0];dir[1] = g_globalvars.v_forward[1];dir[2] = g_globalvars.v_forward[2];
ADDRLP4 12
ADDRGP4 g_globalvars+228
INDIRF4
ASGNF4
...
pop
line 99
;99:	BigAssBullet( dir, 50 );
ADDRLP4 12
ARGP4
CNSTF4 1112014848
ARGF4
ADDRGP4 BigAssBullet
CALLV
pop
line 100
;100:	EjectShell ( );
...
line 103
;101:
;102:	//self->s.v.velocity = (self.velocity - (v_forward * 200));
;103:	VectorScale( g_globalvars.v_forward, 200, vtemp );
ADDRGP4 g_globalvars+228
ARGP4
CNSTF4 1128792064
ARGF4
...
pop
line 104
;104:	VectorSubtract( self->s.v.velocity, vtemp, vtemp );
ADDRLP4 0
ADDRGP4 self
INDIRP4
CNSTI4 180
...
ASGNF4
line 105
;105:	self->s.v.velocity[0] = vtemp[0];
ADDRGP4 self
INDIRP4
CNSTI4 180
ADDP4
...
ASGNF4
line 106
;106:	self->s.v.velocity[1] = vtemp[1];
ADDRGP4 self
INDIRP4
CNSTI4 184
ADDP4
...
ASGNF4
line 107
;107:	if ( vtemp[2] > 179.9 && self->s.v.button2 )
ADDRLP4 0+8
INDIRF4
CNSTF4 1127474790
LEF4 $84
...
EQF4 $84
line 108
;108:		vtemp[2] = vtemp[2] * 2.1;		// "fixes" 20mm jump when facing down
ADDRLP4 0+8
CNSTF4 1074161254
ADDRLP4 0+8
INDIRF4
...
LABELV $84
line 109
;109:	self->s.v.velocity[2] = vtemp[2];
ADDRGP4 self
INDIRP4
CNSTI4 188
ADDP4
...
;113:}
LABELV $64
endproc W_FireBigAss 36 20
export BigAssCarry
proc BigAssCarry 24 16
line 116
;114:
;115:void BigAssCarry ( )
;116:{
line 119
;117:	vec3_t vtemp;
;118:
;119:	makevectors ( PROG_TO_EDICT( self->s.v.owner )->s.v.v_angle );
ADDRGP4 self
INDIRP4
CNSTI4 480
ADDP4
...
pop
line 120
;120:	vtemp[0] = ( PROG_TO_EDICT( self->s.v.owner )->s.v.origin[0] + ( g_globalvars.v_forward[0] * 12 ) + 0 ) + ( g_globalvars.v_right[0] * 5 );
ADDRLP4 0
ADDRGP4 self
INDIRP4
CNSTI4 480
...
ASGNF4
line 121
;121:	vtemp[1] = ( PROG_TO_EDICT( self->s.v.owner )->s.v.origin[1] + ( g_globalvars.v_forward[1] * 12 ) + 0 ) + ( g_globalvars.v_right[1] * 5 );
ADDRLP4 0+4
ADDRGP4 self
INDIRP4
CNSTI4 480
...
ASGNF4
line 122
;122:	vtemp[2] = ( PROG_TO_EDICT( self->s.v.owner )->s.v.origin[2] + ( g_globalvars.v_forward[2] * 12 ) + 20 ) + ( g_globalvars.v_right[2] * 5 );
ADDRLP4 0+8
ADDRGP4 self
INDIRP4
CNSTI4 480
...
line 124
;123:
;124:	setorigin (self, PASSVEC3( vtemp ) );
ADDRGP4 self
INDIRP4
ARGP4
ADDRLP4 0
...
pop
line 125
;125:	VectorCopy( PROG_TO_EDICT( self->s.v.owner )->s.v.angles, self->s.v.angles );
ADDRLP4 12
ADDRGP4 self
INDIRP4
ASGNP4
...
ASGNF4
line 127
;126:	//self->s.v.angles = PROG_TO_EDICT( self->s.v.owner )->s.v.angles;
;127:	self->s.v.think = ( func_t ) BigAssCarry;
ADDRGP4 self
INDIRP4
CNSTI4 280
ADDP4
...
ASGNI4
line 128
;128:	self->s.v.nextthink = g_globalvars.time + 0.02;
ADDRGP4 self
INDIRP4
CNSTI4 288
ADDP4
...
ASGNF4
line 129
;129:}様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様様
LABELV $92
endproc BigAssCarry 24 16
