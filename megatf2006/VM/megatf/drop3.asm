...
;19: *
;20: *
;21: *  $Id: drop3.c,v 1.00 2006/09/15 20:12:21 XavioR Exp $
;22: */
;23:#include "g_local.h"
;24:// Drop3 functions
;25:void	Prox ( );
;26:void	HealSelf ( );
;27:void	DetpackDisarm ( );
;28:void	Drone ( );
;29:
;30:// Drop3 selector function
;31:void Drop3 ( )
;32:{
line 33
;33:	if (!tf_data.drop3)
...
;34:	{
line 35
;35:		G_sprint (self, 2, "Type 3 weapons disabled by Admin!\n");
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 2
...
line 39
;38:	}
;39:	if ( self->playerclass == PC_SCOUT )
ADDRGP4 self
INDIRP4
CNSTI4 820
ADDP4
...
line 40
;40:		DetpackDisarm ( );
ADDRGP4 DetpackDisarm
CALLV
pop
LABELV $16
line 41
;41:	if ( ( self->playerclass == PC_SNIPER ) && ( self->has_syringe == TRUE ) && ( self->tfstate & TFSTATE_AIMING ) )
ADDRLP4 0
ADDRGP4 self
INDIRP4
ASGNP4
...
LABELV $18
line 43
;43:	if( self->playerclass == PC_SOLDIER )
ADDRGP4 self
INDIRP4
CNSTI4 820
ADDP4
...
LABELV $20
line 45
;45:	if ( self->playerclass == PC_MEDIC )
ADDRGP4 self
INDIRP4
CNSTI4 820
ADDP4
...
NEI4 $24
line 49
;48:		// took spycam out because it was never used anyways (not original to mtf either)
;49:	}
LABELV $24
line 50
;50:	if ( self->playerclass == PC_ENGINEER )
ADDRGP4 self
INDIRP4
CNSTI4 820
ADDP4
...
line 53
;52:	//self.impulse = 0; 
;53:}様様様様様様様様様様様様様様様様様様様様様様様様様様
LABELV $11
endproc Drop3 4 12
import Drone
import DetpackDisarm
import HealSelf
import Prox
