export RemoveLavaPool
code
proc RemoveLavaPool 4 20
file "..\src\megatf\mtf_pyro.c"
line 28
;1:/*
;2: *  QWProgs-MegaTF_C
...
;19: *
;20: *
;21: *  $Id: mtf_pyro.c,v 1.00 2006/09/15 XavioR Exp $
;22: */
;23:#include "g_local.h"
;24:
;25:// MTF Pyro Functions
;26:// Lava Pool
;27:void RemoveLavaPool ( )
;28:{
line 29
;29:	gedict_t *owner = PROG_TO_EDICT( self->s.v.owner );
ADDRLP4 0
ADDRGP4 self
INDIRP4
CNSTI4 480
...
line 31
;30:
;31:	G_sprint( owner, 2, "Your Lava has cooled...\n" );
ADDRLP4 0
INDIRP4
ARGP4
CNSTI4 2
...
pop
line 32
;32:	sound( self, 4, "misc/null.wav", 0, 1 );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 4
...
;35:}
LABELV $11
endproc RemoveLavaPool 4 20
export LavaTouch
proc LavaTouch 28 24
line 39
;36:
;37://someone touches the pool..
;38:void LavaTouch ( )
;39:{
line 40
;40:	gedict_t *owner = PROG_TO_EDICT( self->s.v.owner );
ADDRLP4 0
ADDRGP4 self
INDIRP4
CNSTI4 480
...
line 42
;41:
;42:	if ( !streq( other->s.v.classname, "player" ) && other->s.v.classname != "bot" )
ADDRGP4 other
INDIRP4
CNSTI4 216
ADDP4
...
line 49
;48:
;49:	if ( other->s.v.takedamage ) {		// hit something that bleeds/takes damage
ADDRGP4 other
INDIRP4
CNSTI4 340
ADDP4
...
pop
line 51
;51:		TF_T_Damage( other, owner, owner, 2, 0, 16 );
ADDRGP4 other
INDIRP4
ARGP4
ADDRLP4 8
...
GEF4 $25
line 53
;53:			sound( other, 0, "misc/vapeur2.wav", 0.4, 1 );
ADDRGP4 other
INDIRP4
ARGP4
CNSTI4 0
...
LEF4 $28
line 56
;56:				sound( other, 0, "player/inh2o.wav", 0.8, 1 );
ADDRGP4 other
INDIRP4
ARGP4
CNSTI4 0
...
LABELV $31
line 61
;61:		if ( other->team_no == owner->team_no )
ADDRLP4 16
CNSTI4 960
ASGNI4
ADDRGP4 other
...
line 64
;63:
;64:		other->s.v.origin[0] = self->s.v.origin[0];
ADDRLP4 20
CNSTI4 156
ASGNI4
ADDRGP4 other
...
ASGNF4
line 65
;65:		other->s.v.origin[1] = self->s.v.origin[1];
ADDRLP4 24
CNSTI4 160
ASGNI4
ADDRGP4 other
...
;67:}
LABELV $14
endproc LavaTouch 28 24
export LavaBallTouch
proc LavaBallTouch 16 24
line 71
;68:
;69://someone touches the ball (pre-pool)
;70:void LavaBallTouch ( )
;71:{
line 72
;72:	gedict_t *owner = PROG_TO_EDICT( self->s.v.owner );
ADDRLP4 0
ADDRGP4 self
INDIRP4
CNSTI4 480
...
line 74
;73:
;74:	if ( other == owner )		// you can't be harmed by your own lava pool
ADDRGP4 other
INDIRP4
CVPU4 4
ADDRLP4 0
...
line 77
;76:
;77:	sound( self, 1, "zombie/z_miss.wav", 1, 1 );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 1
...
;79:	{
line 80
;80:		if ( !streq( other->s.v.classname, "player" ) )
ADDRGP4 other
INDIRP4
CNSTI4 216
ADDP4
...
LABELV $46
line 86
;86:		if ( other->team_no == owner->team_no )
ADDRLP4 12
CNSTI4 960
ASGNI4
ADDRGP4 other
...
pop
line 90
;90:		TF_T_Damage( other, self, owner, 20, 0, 16 );
ADDRGP4 other
INDIRP4
ARGP4
ADDRGP4 self
...
;92:}
LABELV $36
endproc LavaBallTouch 16 24
export LavaBecome
proc LavaBecome 12 28
line 96
;93:
;94://become that funkeh pool! :0
;95:void LavaBecome ( )
;96:{
line 98
;97:	// there is no lava in water!
;98:	if ( self->s.v.waterlevel > 1 )
ADDRGP4 self
INDIRP4
CNSTI4 432
ADDP4
...
line 101
;100:
;101:	setmodel( self, "progs/lavapool.mdl" );
ADDRGP4 self
INDIRP4
ARGP4
ADDRGP4 $53
...
pop
line 102
;102:	SetVector( self->s.v.avelocity, 0, 0, 0 );
ADDRGP4 self
INDIRP4
CNSTI4 204
ADDP4
...
ASGNF4
line 103
;103:	self->s.v.effects = EF_DIMLIGHT;
ADDRGP4 self
INDIRP4
CNSTI4 232
ADDP4
...
ASGNP4
line 106
;106:	sound( self, 4, "weapons/lavapool.wav", 1, 1 );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 4
...
ASGNF4
line 110
;110:	setsize( self, -12, -12, 0, 12, 12, 2 );
ADDRGP4 self
INDIRP4
ARGP4
ADDRLP4 4
...
pop
line 111
;111:	self->s.v.nextthink = g_globalvars.time + 30;
ADDRGP4 self
INDIRP4
CNSTI4 288
ADDP4
...
ASGNF4
line 112
;112:	self->s.v.think = ( func_t ) RemoveLavaPool;
ADDRGP4 self
INDIRP4
CNSTI4 280
ADDP4
ADDRGP4 RemoveLavaPool
CVPU4 4
CVUI4 4
ASGNI4
line 113
;113:	self->s.v.touch = ( func_t ) LavaTouch;
ADDRGP4 self
INDIRP4
CNSTI4 272
ADDP4
...
;114:}
LABELV $50
endproc LavaBecome 12 28
export LavaPool
proc LavaPool 24 28
line 117
;115:// spawn the lava pool (called from drop1)
;116:void LavaPool ( )
;117:{
line 119
;118:	// only one!
;119:	if ( self->has_syringe != 1 ) {
ADDRGP4 self
INDIRP4
CNSTI4 1764
ADDP4
...
EQI4 $58
line 120
;120:		G_sprint( self, 2, "You get 1 Lava Pool at a time!\n" );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 2
...
line 123
;122:	}
;123:	self->has_syringe = 0;		// why did Ambush make drop commands use this one var i do not know..
ADDRGP4 self
INDIRP4
CNSTI4 1764
ADDP4
...
line 125
;124:
;125:	sound( self, 3, "weapons/throw.wav", 1, 1 );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 3
...
ASGNP4
line 127
;127:	newmis->s.v.classname = "timer";
ADDRGP4 newmis
INDIRP4
CNSTI4 216
ADDP4
...
ASGNP4
line 128
;128:	newmis->s.v.owner = EDICT_TO_PROG( self );
ADDRGP4 newmis
INDIRP4
CNSTI4 480
ADDP4
...
ASGNI4
line 129
;129:	newmis->team_no = self->team_no;
ADDRLP4 8
CNSTI4 960
ASGNI4
ADDRGP4 newmis
...
ASGNI4
line 130
;130:	newmis->s.v.health = g_globalvars.time;
ADDRGP4 newmis
INDIRP4
CNSTI4 296
ADDP4
...
ASGNF4
line 134
;134:	newmis->team_no = self->team_no;
ADDRLP4 12
CNSTI4 960
ASGNI4
ADDRGP4 newmis
...
ASGNI4
line 135
;135:	makevectors( self->s.v.v_angle );
ADDRGP4 self
INDIRP4
CNSTI4 384
ADDP4
...
EQF4 $63
line 138
;138:		newmis->s.v.velocity[0] = g_globalvars.v_forward[0] * 400 + g_globalvars.v_up[0] * 200;
ADDRGP4 newmis
INDIRP4
CNSTI4 180
ADDP4
...
ASGNF4
line 139
;139:		newmis->s.v.velocity[1] = g_globalvars.v_forward[1] * 400 + g_globalvars.v_up[1] * 200;
ADDRGP4 newmis
INDIRP4
CNSTI4 184
ADDP4
...
ASGNF4
line 140
;140:		newmis->s.v.velocity[2] = g_globalvars.v_forward[2] * 400 + g_globalvars.v_up[2] * 200;
ADDRGP4 newmis
INDIRP4
CNSTI4 188
ADDP4
...
pop
line 145
;145:		VectorScale( newmis->s.v.velocity, 400, newmis->s.v.velocity );
ADDRLP4 16
ADDRGP4 newmis
INDIRP4
CNSTI4 180
...
LABELV $64
line 148
;148:	SetVector( self->s.v.avelocity, 0, 0, 0 );
ADDRGP4 self
INDIRP4
CNSTI4 204
ADDP4
...
ASGNF4
line 149
;149:	setsize( newmis, 0, 0, 0, 0, 0, 0 );
ADDRGP4 newmis
INDIRP4
ARGP4
ADDRLP4 16
...
pop
line 150
;150:	setorigin( newmis, PASSVEC3( self->s.v.origin ) );
ADDRGP4 newmis
INDIRP4
ARGP4
ADDRLP4 20
...
pop
line 151
;151:	newmis->s.v.nextthink = g_globalvars.time + 2;
ADDRGP4 newmis
INDIRP4
CNSTI4 288
ADDP4
...
ASGNF4
line 152
;152:	newmis->s.v.think = ( func_t ) LavaBecome;
ADDRGP4 newmis
INDIRP4
CNSTI4 280
ADDP4
...
ASGNI4
line 153
;153:	newmis->s.v.touch = ( func_t ) LavaBallTouch;
ADDRGP4 newmis
INDIRP4
CNSTI4 272
ADDP4
ADDRGP4 LavaBallTouch
CVPU4 4
CVUI4 4
ASGNI4
line 154
;154:	setmodel( newmis, "progs/lavaball.mdl" );
ADDRGP4 newmis
INDIRP4
ARGP4
ADDRGP4 $76
