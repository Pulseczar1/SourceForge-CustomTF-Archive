...
;19: *
;20: *
;21: *  $Id: mtf_medic.c,v 1.00 2006/09/15 XavioR Exp $
;22: */
;23:#include "g_local.h"
;24:
;25:// MTF Medic Functions
;26:// Heal Self (thx plast for original code)
;27:void HealSelf ( )
;28:{
line 33
;29:	float   healed;
;30:	gedict_t *te;
;31:
;32:	// Only medic's can heal themselves
;33:	if ( self->playerclass != PC_MEDIC )
ADDRGP4 self
INDIRP4
CNSTI4 820
ADDP4
...
line 37
;35:
;36:	// Costs 1 type 2 gren
;37:	if ( self->no_grenades_2 < 1 ) {
ADDRGP4 self
INDIRP4
CNSTI4 844
ADDP4
...
GEI4 $14
line 38
;38:		G_sprint( self, 2, "Not enough type 2 grenades... get more\n" );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 2
...
line 44
;43:
;44:	for ( te=world ; (te = trap_find( te, FOFS( s.v.classname ), "timer" ));)
ADDRLP4 0
ADDRGP4 world
INDIRP4
ASGNP4
...
;45:	{
line 46
;46:		if ( te->s.v.owner != g_globalvars.self )
ADDRLP4 0
INDIRP4
CNSTI4 480
ADDP4
...
LABELV $22
line 48
;48:		if ( te->s.v.think != ( func_t ) ConcussionGrenadeTimer &&
ADDRLP4 8
ADDRLP4 0
INDIRP4
CNSTI4 280
...
EQI4 $25
line 50
;49:			te->s.v.think != ( func_t ) OldConcussionGrenadeTimer )
;50:			continue;
ADDRGP4 $18
JUMPV
LABELV $25
line 51
;51:		if ( tf_data.old_grens == 1 )
ADDRGP4 tf_data+44
INDIRI4
CNSTI4 1
NEI4 $27
line 52
;52:			stuffcmd( self, "v_idlescale 0\n" );
ADDRGP4 self
INDIRP4
ARGP4
ADDRGP4 $30
...
LABELV $27
line 54
;53://			stuffcmd( self, "v_idlescale 0\nfov 90\n" );
;54:		dremove( te );
ADDRLP4 0
INDIRP4
ARGP4
...
pop
line 55
;55:		G_sprint ( self, 2, "you have been healed of your concussion\n" );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 2
...
line 59
;58:	}
;59:	if ( self->tfstate & TFSTATE_HALLUCINATING )
ADDRGP4 self
INDIRP4
CNSTI4 892
ADDP4
...
;60:	{
line 61
;61:	    for ( te=world ; (te = trap_find( te, FOFS( s.v.classname ), "timer" ));)
ADDRLP4 0
ADDRGP4 world
INDIRP4
ASGNP4
...
;62:		{
line 63
;63:			if ( te->s.v.owner != g_globalvars.self )
ADDRLP4 0
INDIRP4
CNSTI4 480
ADDP4
...
LABELV $38
line 65
;65:			if ( te->s.v.think != ( func_t ) HallucinationTimer )
ADDRLP4 0
INDIRP4
CNSTI4 280
ADDP4
...
line 68
;67:
;68:			self->tfstate -= ( self->tfstate & TFSTATE_HALLUCINATING );
ADDRLP4 12
ADDRGP4 self
INDIRP4
CNSTI4 892
...
ASGNI4
line 69
;69:			G_sprint (self, 2, "you have been healed of your hallucinations\n");
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 2
...
pop
line 73
;73:			if ( tf_data.new_gas & GAS_MASK_PALETTE) 
ADDRGP4 tf_data+144
INDIRI4
CNSTI4 16
BANDI4
...
EQI4 $44
line 74
;74:				stuffcmd( self, "v_cshift; wait; bf\n" );
ADDRGP4 self
INDIRP4
ARGP4
ADDRGP4 $47
...
NEU4 $48
line 79
;79:			G_conprintf( "Warning: Error in Hallucination Timer logic.\n" );
ADDRGP4 $50
ARGP4
ADDRGP4 G_conprintf
CALLV
...
LABELV $32
line 81
;81:	if ( self->tfstate & TFSTATE_TRANQUILISED )
ADDRGP4 self
INDIRP4
CNSTI4 892
ADDP4
...
;82:	{
line 83
;83:	    for ( te=world ; (te = trap_find( te, FOFS( s.v.classname ), "timer" ));)
ADDRLP4 0
ADDRGP4 world
INDIRP4
ASGNP4
...
;84:		{
line 85
;85:			if ( te->s.v.owner != g_globalvars.self )
ADDRLP4 0
INDIRP4
CNSTI4 480
ADDP4
...
LABELV $57
line 87
;87:			if ( te->s.v.think != ( func_t ) TranquiliserTimer )
ADDRLP4 0
INDIRP4
CNSTI4 280
ADDP4
...
line 90
;89:
;90:			self->tfstate -= ( self->tfstate & TFSTATE_TRANQUILISED );
ADDRLP4 12
ADDRGP4 self
INDIRP4
CNSTI4 892
...
pop
line 92
;92:			G_sprint ( self, 2, "you have been healed of your tranquilisation\n" );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 2
...
NEU4 $63
line 98
;98:			G_conprintf( "Warning: Error in Tranquilisation Timer logic.\n" );
ADDRGP4 $65
ARGP4
ADDRGP4 G_conprintf
CALLV
...
;101:	{
line 102
;102:	    for ( te=world ; (te = trap_find( te, FOFS( s.v.netname ), "flashtimer" ));)
ADDRLP4 0
ADDRGP4 world
INDIRP4
ASGNP4
...
;103:		{
line 104
;104:			if ( te->s.v.owner != g_globalvars.self )
ADDRLP4 0
INDIRP4
CNSTI4 480
ADDP4
...
LABELV $73
line 106
;106:			if ( strneq( te->s.v.classname, "timer" ) )
ADDRLP4 0
INDIRP4
CNSTI4 216
ADDP4
...
ASGNF4
line 111
;111:			if ( tf_data.new_flash )
ADDRGP4 tf_data+48
INDIRI4
CNSTI4 0
EQI4 $70
line 112
;112:				disableupdates( self, -1 );	/* server-side flash */
ADDRGP4 self
INDIRP4
ARGP4
CNSTF4 3212836864
...
;116:		{
line 117
;117:			G_conprintf( "Warning: Error in Flash Timer logic.\n" );
ADDRGP4 $83
ARGP4
ADDRGP4 G_conprintf
CALLV
...
;123:	{
line 124
;124:		G_sprint ( self, 2, "Your leg wound has been healed!\n" );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 2
...
ASGNI4
line 126
;126:		TeamFortress_SetSpeed ( self );
ADDRGP4 self
INDIRP4
ARGP4
ADDRGP4 TeamFortress_SetSpeed
...
;130:	{
line 131
;131:		sound( self, 1, "items/r_item1.wav", 1, 1 );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 1
...
ASGNI4
line 133
;133:		G_sprint ( self, 2, "The flames have been doused!\n" );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 2
...
NEF4 $91
line 139
;139:		G_sprint( self, 2, "You have nothing to cure.\n" );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 2
...
;140:	else {
line 141
;141:		self->no_grenades_2 = self->no_grenades_2 - 1;
ADDRLP4 12
ADDRGP4 self
INDIRP4
CNSTI4 844
...
line 143
;142:
;143:		trap_WriteByte( MSG_MULTICAST, 23 );
CNSTI4 4
ARGI4
CNSTI4 23
ARGI4
...
pop
line 144
;144:		trap_WriteByte( MSG_MULTICAST, 11 );
CNSTI4 4
ARGI4
CNSTI4 11
ARGI4
...
pop
line 145
;145:		trap_WriteCoord( MSG_MULTICAST, self->s.v.origin[0] );
CNSTI4 4
ARGI4
ADDRGP4 self
INDIRP4
...
pop
line 146
;146:		trap_WriteCoord( MSG_MULTICAST, self->s.v.origin[1] );
CNSTI4 4
ARGI4
ADDRGP4 self
INDIRP4
...
pop
line 147
;147:		trap_WriteCoord( MSG_MULTICAST, self->s.v.origin[2] );
CNSTI4 4
ARGI4
ADDRGP4 self
INDIRP4
...
pop
line 148
;148:		trap_multicast( PASSVEC3( self->s.v.origin ), 1 );
ADDRLP4 16
ADDRGP4 self
INDIRP4
ASGNP4
...
line 150
;149:
;150:		sound ( self, 3, "items/r_item2.wav", 1, 1 );
ADDRGP4 self
INDIRP4
ARGP4
CNSTI4 3
