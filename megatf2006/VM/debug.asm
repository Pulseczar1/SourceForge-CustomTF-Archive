...
;19: *
;20: *
;21: *  $Id: debug.c,v 1.5 2005/05/23 18:54:02 AngelD Exp $
;22: */
;23:#include "g_local.h"
;24:
;25:void dremove( gedict_t * te )
;26:{
line 27
;27:	if ( !te || te == world )
ADDRLP4 0
...
;28:	{
line 29
;29:		G_dprintf( "***BUG BUG BUG BUG BUG BUG BUG BUG BUG BUG***\n" );
ADDRGP4 $15
ARGP4
ADDRGP4 G_dprintf
CALLV
pop
line 30
;30:		G_dprintf( "WORLD has nearly been removed. Don't worry\n" );
ADDRGP4 $16
ARGP4
ADDRGP4 G_dprintf
CALLV
pop
line 31
;31:		G_dprintf( "***BUG BUG BUG BUG BUG BUG BUG BUG BUG BUG***\n" );
ADDRGP4 $15
ARGP4
ADDRGP4 G_dprintf
CALLV
...
LABELV $11
endproc dremove 4 4
export display_location
proc display_location 8 24
line 41
;39:
;40:void display_location(  )
;41:{
line 42
;42:	G_sprint( self, 2, "Location : '%.0f %.0f %.0f'\n", self->s.v.origin[0], self->s.v.origin[1], self->s.v.origin[2] );
ADDRLP4 0
ADDRGP4 self
INDIRP4
ASGNP4
