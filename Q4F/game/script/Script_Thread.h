...
// twhitaker: ceil, floor and intVal
	...
	void						Event_IsNull( idEntity* ent );
	void						Event_IsPlayer( idEntity* ent );

	void						Event_StatsFlagCaptured( idEntity* flag, idEntity* carrier );
	void						Event_StatsFlagTaken( idEntity* flag, idEntity* carrier );
	void						Event_StatsFlagDropped( idEntity* flag, idEntity* carrier );

	void						Event_SetMapGuiFloat( int varNum, float val );
	void						Event_SetMapGuiString( int varNum, const char* val );
	void						Event_SetMapGuiInt( int varNum, int val );
	void						Event_SetMapGuiBool( int varNum, bool val );
	void						Event_MapGuiNamedEvent( int eventNum );
	void						Event_GetNextPlayer( idEntity* player );
	void						Event_AddAward( const char* awardStr );
