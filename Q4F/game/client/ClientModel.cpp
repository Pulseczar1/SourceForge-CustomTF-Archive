...
/*
================
rvClientModel::SetColor
================
*/
void rvClientModel::SetColor( float red, float green, float blue, float alpha ) {
...
================
*/
void rvClientModel::SetColor( const idVec3 &color ) {
...
/*
================
rvClientModel::GetColor
================
*/
void rvClientModel::GetColor( idVec3 &out ) const {
...
================
*/
void rvClientModel::SetColor( const idVec4 &color ) {
...
================
*/
void rvClientModel::GetColor( idVec4 &out ) const {
	out[ 0 ] = renderEntity.shaderParms[ SHADERPARM_RED ];
	out[ 1 ] = renderEntity.shaderParms[ SHADERPARM_GREEN ];
	out[ 2 ] = renderEntity.shaderParms[ SHADERPARM_BLUE ];
