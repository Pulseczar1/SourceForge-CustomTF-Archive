...
// 3j: updated water level to be % of body covered in water
#define WATERLEVEL_NONE		0.010f
#define WATERLEVEL_FEET		0.150f
#define WATERLEVEL_WAIST	0.600f
#define WATERLEVEL_HEAD		0.850f
...
public:
	const float				GetWaterLevel( void ) { return waterLevel; };
	const int				GetWaterType( void ) { return waterType; };

protected:

	virtual bool			SetWaterLevel( void ) { return false; };
