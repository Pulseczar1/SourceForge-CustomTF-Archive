...
// ddynerman: multiple clip worlds
	return gameLocal.clip.TracePoint ( results, start, end, contentMask, gameLocal.GetLocalPlayer() );
...
// ddynerman: multiple clip worlds
	return gameLocal.clip.TracePoint( results, start, end, contentMask, NULL );
...
idAASFile* idGameEdit::GetAASFile( int i ) { return 0; }
